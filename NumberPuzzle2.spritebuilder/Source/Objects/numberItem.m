...
- (void) didLoadFromCCB
{
    m_spriteSelect.visible = NO;
    m_arrayNumberSprite = @[m_spriteOne
                            ,m_spriteTwo
                            ,m_spriteThree
                            ,m_spriteFour
                            ,m_spriteFive
...
{
    m_type = type;
    for (CCNode *obj in m_arrayNumberSprite)
    {
        obj.visible = NO;
    }
    CCSprite *numberSprite = [m_arrayNumberSprite objectAtIndex:(NSInteger)type-1];
    numberSprite.visible = YES;
